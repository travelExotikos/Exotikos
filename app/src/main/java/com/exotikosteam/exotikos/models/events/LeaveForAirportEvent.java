...
public class LeaveForAirportEvent extends FlightEventProcessor {

    private Period triggerTime;

    public LeaveForAirportEvent(Context mContext, Period triggerIntervalBeforeDeparture) {
        super(mContext);
    ...
    public void onFire(EventInputContext context) {
        ...
        sendPushNotification(intent, flightName,
                String.format(mContext.getString(R.string.leave_for_airport_notification), context.getFlight().getDepartureAirportIATA()));
    }
}
